/*
 * slush-slush-mail-generator
 * https://github.com/sbarchetta/slush-mail-generator
 *
...
gulp.task('default', function (done) {
    ...
    inquirer.prompt(prompts,
        function (answers) {
            ...
            // Setear parametros internos
            // Path absoluto a templates y css
            ...
            gulp.src(__dirname + '/templates/**')
                ...
                .pipe(conflict('./'))
                .pipe(gulp.dest('./' + answers.mailName))
                .pipe(install())
                .on('end', function () {
                    done();
                });
